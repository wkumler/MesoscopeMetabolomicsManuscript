...
Word counts:
  ...
  - Main text (excludes the abstract, section titles, figure and table captions, funding statement, acknowledgments, and references): 8,200
  - Number of figures: 6
  - Number of tables: 0
...
raafay_notes <- read_csv("../targeted/raw_data/Raafay_HILIC_notes.csv") %>%
  select(compound_name, in_samps, polarity)
