...
author:
  - William Kumler,$^a$ Wei Qin,$^{a*}$ Rachel A. Lundeen,$^a$ Benedetto Barone,$^b$ Laura T. Carlson,$^a$ Anitra E. Ingalls$^a$#
output: 
  word_document:
...
$^a$School of Oceanography, University of Washington, Seattle, WA, USA

$^b$Daniel K. Inouye Center for Microbial Oceanography: Research and Education and Department of Oceanography, University of Hawai'i at Mānoa, Honolulu, HI, USA

Running head: Metabolites reflect variability introduced by eddies

\#Address correspondence to Anitra E. Ingalls, aingalls\@uw.edu
...
Word counts:
  ...
  - Abstract: 216
  - Importance: 123
  - Main text (excluding Methods, figure captions, references, etc.): 5453
