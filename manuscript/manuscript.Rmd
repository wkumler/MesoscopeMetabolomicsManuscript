...
ggsave("fig_2_nmds_and_med_metab.png", plot = nmds_and_med_metab, device = "png", 
       path = "figures/lowres", width = 6.875, height = 4.5, units = "in", dpi = 72,
       bg="white")
```
...
ggsave("fig_3_targ_gp_w_sla_frac.png", plot = targ_gp_w_sla_frac, device = "png",
       path = "figures/lowres", width = 6.875, height = 5.5, units = "in", dpi = 72,
       bg = "white")
```
...
neg_msdata <- grabMSdata(list.files("../tmzMLs/neg", pattern = "180821_Smp", full.names = TRUE), verbosity = 0)
...
ggsave("fig_5_kclust_volcano_gp.png", plot = kclust_volcano_gp, device = "png", 
       path = "figures/lowres", width = 6.875, height = 5, units = "in", dpi = 72,
       bg="white")
```
...
ggsave("fig_6_fk_nmdsplot.png", plot = fk_nmdsplot, device = "png",
       path = "figures/lowres", width = 6.875, height = 4, units = "in", dpi = 72,
       bg="white")
```
